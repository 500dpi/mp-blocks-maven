...
public class Art80x24 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    AsciiBlock spiders = new HComp(VAlignment.TOP, new AsciiBlock[] { spider1, spider3, spider2, new Line(" ") });
    ...
    AsciiBlock.print(pen, new VComp(HAlignment.CENTER, new AsciiBlock[] { web, finalSpiders, floor }));
    pen.close();
  } // main(String[])
} // class Art80x24
